...
Esos porcentajes no son valores al azar: salen de ordenar todos los datos de menor a mayor y marcar posiciones. El 25% es el valor que deja atrás a una cuarta parte de los datos, el 50% es justo la mitad (la mediana) y el 75% deja atrás tres cuartas partes. Sirven para ver la forma de los datos sin que los extremos engañen; por ejemplo, si la mediana queda mucho menor que la media, es señal de que hay pocos valores muy grandes jalando el promedio hacia arriba.
